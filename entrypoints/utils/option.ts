export const services = {
	...
	cozecn: "cozecn",
	huanYuan: "huanYuan",
	huanYuanTranslation: "huanYuanTranslation",
	doubao: "doubao",
...
export const servicesType = {
	...
	isOllama: (service: string) => service === services.ollama,
	isUseAkSk: (service: string) => service === services.yiyan,
	isCoze: (service: string) =>
		service === services.cozecom || service === services.cozecn,
	isYoudao: (service: string) => service === services.youdao,
	isTencent: (service: string) =>
		service === services.tencent || service === services.huanYuanTranslation,
	...
	isOpenAICompatible: (service: string) =>
		servicesType.openaiCompatible.has(service),
};
...
export const models = new Map<string, Array<string>>([
	...
	[
		services.claude,
		["claude-sonnet-4-0", "claude-opus-4-1", "claude-3-5-haiku-latest"],
	],
	[
		services.custom,
		[
	...
	[
		services.baichuan,
		["Baichuan4-Air", "Baichuan4-Turbo", "Baichuan4", customModelString],
	],
	[services.lingyi, ["yi-lightning", customModelString]],
	[
		services.deepseek,
		["deepseek-chat", "deepseek-reasoner", customModelString],
	],
	...
	[
		services.huanYuanTranslation,
		["hunyuan-translation", "hunyuan-translation-lite", customModelString],
	],
	[
		services.newapi,
		[
...
export const options = {
	...
	services: [
		...
		{ value: services.mtranServer, label: "MTranServer" },
		...
		{ value: services.chromeTranslator, label: "Chrome 内置 Gemini" },
		{ value: services.siliconCloud, label: "硅基流动" },
		{ value: services.huanYuan, label: "腾讯混元" },
		{ value: services.newapi, label: "NewAPI" },
		{ value: services.ollama, label: "Ollama" },
		...
		{ value: services.grok, label: "Grok" },
		...
		{ value: services.cozecom, label: "Coze 国际版" },
		{ value: services.cozecn, label: "Coze 国内版" },
	...
	styles: [
		...
		},
		{
			value: 8,
			label: "渐变卡片",
			class: "fluent-display-modern-card",
			group: "card",
		},
		{
			value: 9,
			label: "纸张卡片",
			class: "fluent-display-paper",
			group: "card",
		},
		...
		},
		{
			value: 12,
			label: "柔和渐变",
			class: "fluent-display-highlight-fade",
			group: "highlight",
		},
		...
		},
		{
			value: 18,
			label: "阅读焦点",
			class: "fluent-display-focus",
			group: "special",
		},
		{
			value: 19,
			label: "简约底线",
			class: "fluent-display-clean",
			group: "special",
		},
		...
		{ value: "pro", label: "专业样式", disabled: true },
		{
			value: 20,
			label: "代码风格",
			class: "fluent-display-tech",
			group: "pro",
		},
		{
			value: 21,
			label: "书籍风格",
			class: "fluent-display-elegant",
			group: "pro",
		},
...
export const defaultOption = {
	...
	display: 1,
	hotkey: "Control",
	service: services.mtranServer,
	mtranServerUrl: "http://localhost:8989/translate",
